---
description: Assigns agent the create-application-plan assignment
model: google/gemini-2.5-pro
---

You have been assigned the `create-application-plan` assignment.
...
After reading the instructions for your workflow assignment, look for your `new-ai-app-template.md` app template in the docs/ directory. (This should have been already explained in your instructions)

<!--
Read, use, and adhere to the following instructions files.

- ai-create-application-plan.md
...
[ai-instructions-aspnet-guidelines](../ai_instruction_modules/ai-instructions-aspnet-guidelines.md)
-->

<!--
copilot-source:
  file: create-app-from-plans.prompt.md
  mode: agent
