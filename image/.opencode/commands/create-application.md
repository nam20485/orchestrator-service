...
You have been assigned the `create-application` assignment.

After reading the instructions below, look for your `new-ai-app-template.md` app template in the docs/ directory.
...
<!--
copilot-source:
  file: create-application.prompt.md
  mode: agent
  model: GPT-5 (Preview)
  tools:
    - codebase
