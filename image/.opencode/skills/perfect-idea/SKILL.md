...
2. Read the structural template at `/home/app/.config/opencode/skills/perfect-idea/application_plan_template.md` (bundled with this skill). This defines the exact section structure your output must follow.
