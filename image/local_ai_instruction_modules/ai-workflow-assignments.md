...
- shortId: create-feature-plan

- GitHub UI: [create-feature-plan](https://github.com/nam20485/agent-instructions/blob/main/ai_instruction_modules/ai-workflow-assignments/create-feature-plan.md)
- Raw URL:   [create-feature-plan](https://raw.githubusercontent.com/nam20485/agent-instructions/main/ai_instruction_modules/ai-workflow-assignments/create-feature-plan.md)
- Canonical file: `ai_instruction_modules/ai-workflow-assignments/create-feature-plan.md`
...
- shortId: create-repository-summary

- GitHub UI: [create-repository-summary](https://github.com/nam20485/agent-instructions/blob/main/ai_instruction_modules/ai-workflow-assignments/create-repository-summary.md)
- Raw URL:   [create-repository-summary](https://raw.githubusercontent.com/nam20485/agent-instructions/main/ai_instruction_modules/ai-workflow-assignments/create-repository-summary.md)
- Canonical file: `ai_instruction_modules/ai-workflow-assignments/create-repository-summary.md`
...
- shortId: create-workflow-plan

- GitHub UI: [create-workflow-plan](https://github.com/nam20485/agent-instructions/blob/main/ai_instruction_modules/ai-workflow-assignments/create-workflow-plan.md)
- Raw URL:   [create-workflow-plan](https://raw.githubusercontent.com/nam20485/agent-instructions/main/ai_instruction_modules/ai-workflow-assignments/create-workflow-plan.md)
- Canonical file: `ai_instruction_modules/ai-workflow-assignments/create-workflow-plan.md`
